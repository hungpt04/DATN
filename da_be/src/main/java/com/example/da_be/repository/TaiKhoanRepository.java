...
public interface TaiKhoanRepository extends JpaRepository<TaiKhoan, Integer> {
    ...
    @Query(
            """
        SELECT new com.example.da_be.entity.TaiKhoan(tk.id, tk.ma, tk.hoTen, tk.sdt, tk.email, tk.matKhau, tk.gioiTinh, tk.vaiTro, tk.avatar, tk.ngaySinh, tk.cccd, tk.trangThai)
        FROM TaiKhoan tk
