    ...
    return (
        <div className="flex flex-wrap">
            <div className="productCard w-[195px] m-3 transition-all cursor-pointer relative">
                ...
                {promotion && (
                    <div className="absolute text-white px-2 py-1 rounded-full text-xs z-10">
                        <p className="text-green-600 font-semibold text-sm">{promotion.khuyenMai.giaTri}% off</p>
                    </div>
                )}

                {/* Out of stock badge */}
                {product.soLuong === 0 && (
                    <div className="absolute top-0 left-0 bg-red-600 text-white px-2 py-1 rounded-br-lg text-xs z-20">
                        Hết hàng
                    </div>
                )}
