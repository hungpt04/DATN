...
//         // Kiểm tra trạng thái của sản phẩm chi tiết
//         if (selectedVariant.trangThai === 0) {
//             swal('Thất bại!', 'Sản phẩm này không thể thêm vào giỏ hàng!', 'error');
//             return;
//         }
...
//         console.log('trang thai: ', selectedVariant);
...
//                                                 // Kiểm tra cả số lượng và trạng thái
//                                                 const inStock =
//                                                     variant && variant.soLuong > 0 && variant.trangThai !== 0;
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                {/* Cập nhật phần hiển thị tình trạng */}
                                {/* <p>
                                    Tình trạng:{' '}
                                    <span className="text-[#2f19ae]">
                                        {(() => {
                                            const selectedVariant = product.variants.find(
                                                (v) =>
                                                    v.mauSacTen === selectedColor && v.trongLuongTen === selectedWeight,
                                            );

                                            if (!selectedVariant) return 'Chưa chọn';

                                            if (selectedVariant.trangThai === 0) return 'Ngừng kinh doanh';

                                            return selectedVariant.soLuong > 0 ? 'Còn hàng' : 'Hết hàng';
                                        })()}
                                    </span>
                                </p>
                                ...
                                <p>
                                    ...
                                    <span className="text-[#2f19ae]">
                                        {(() => {
                                            ...
                                            return selectedVariant && selectedVariant.trangThai !== 0
